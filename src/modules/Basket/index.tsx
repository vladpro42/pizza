...
const Basket = () => {
    return <div className="basket__wrapper">
        <div className="top">
            ...
            <button className="basket__clear-btn">
        ...
        <div className="statistics">
            <p className="statistics__number-of-pizzas">Всего пицц: <b>3 шт.</b></p>
            <p className="statistics__price">Сумма заказа: <b className="bold__orange">900 ₽</b></p>
        </div>
        <div className="basket__nav">
            <button className="nav__back">&lsaquo;<span>Вернуться назад</span></button>
